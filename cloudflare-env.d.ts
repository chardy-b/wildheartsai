/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 74f210303f8fa76506f4a7f884dc2d7d)
// Runtime types generated with workerd@1.20260925.1 2026-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	SIGNUPS_ENABLED: string;
	EPIC_ENVIRONMENT: string;
	EPIC_PRODUCTION_ACCESS_ENABLED: string;
	EMAIL_FROM: string;
	SYNC_WORKFLOW: Workflow<Parameters<import("./worker").SyncWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIGNUPS_ENABLED" | "EPIC_ENVIRONMENT" | "EPIC_PRODUCTION_ACCESS_ENABLED" | "EMAIL_FROM">> {}
}
